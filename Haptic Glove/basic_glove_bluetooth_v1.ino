...
int scaledInput[4];			// scaled sensor values for PWM output
...
void loop() {
	...
	//Serial.write(scaledInput,2);						// Send the scaled input reading to the motor via bluetooth (serial)
	//Serial.write((uint8_t *)scaledInput, (size_t)4);
    delay(50);
}
